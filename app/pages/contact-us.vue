...
if (page?.value) {
	...
	useSEO({
		title: page.value?.title || "Contact Us",
		description: page.value?.description || "Get in touch with us",
	...
	<main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
		...
		<section v-if="!pagePending && page?.value" class="space-y-8">
			...
			<NuxtImg
				...
				:alt="page.value.image.title || 'Contact Us'"
		...
		<section v-else class="space-y-8">
			...
			<p class="text-xl text-gray-400 leading-relaxed mb-8">
				We'd love to hear from you. Get in touch with us through any of the following
				channels.
			</p>
			<div class="prose prose-lg prose-invert max-w-none text-gray-300">
				<p>
					...
					the URL "/contact-us" to display custom content here.
				</p>
			</div>
		</section>
	</main>
